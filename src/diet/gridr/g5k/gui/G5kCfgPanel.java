...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: G5kCfgPanel.java,v 1.17 2007/11/19 15:16:19 dloureir Exp $
 * $Log: G5kCfgPanel.java,v $
 * Revision 1.17  2007/11/19 15:16:19  dloureir
...
//    private JButton    applyBtn;
    ...
    public G5kCfgPanel(String site, int index) {
        ...
        initComponents();
        LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, this.getClass().getName(), "G5kCfgPanel", "G5k Config Cluster Panel initialized");
    }
...
//        add(panel, c);
    ...
    protected void fillValues() {
        ...
        LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, this.getClass().getName(), "fillValues", "Configuration values filled for site : " + G5kSite.getSiteForIndex(myIndex));
    }
    ...
    public void apply() {
        ...
        LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, this.getClass().getName(), "apply", "Configuration values updated for site : " + G5kSite.getSiteForIndex(myIndex));
    }
...
//        }
        if (event.getSource() == this.importBtn) {
            ...
            if (selectedSite == null) {
                ...
                LoggingManager.log(Level.WARNING, LoggingManager.RESOURCESTOOL, this.getClass().getName(), "actionPerformed", "No site selected or the selected site was not found");
                return;
            }
            ...
            if (cfg != null) {
                ...
                LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, this.getClass().getName(), "actionPerformed", "Cluster config updated from site " + G5kSite.getSiteForIndex(index));
            }
        }
    }
    ...
    private class ListOfPropertyJPanel extends JPanel{
        ...
        private void initialize(){
        	...
        	scrollPane.setMaximumSize(new Dimension(460,400));
        	scrollPane.setMinimumSize(new Dimension(460,400));
