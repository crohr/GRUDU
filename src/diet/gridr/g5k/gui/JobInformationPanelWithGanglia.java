 ...
 *
 */
public class JobInformationPanelWithGanglia extends JPanel{
	...
	private static String gangliaHistoryTitle = "<html><center>Ganglia<br> Info</center></html>";

	public JobInformationPanelWithGanglia(GridJob aJob, Connection aConnection, String siteName){
		job = aJob;
