...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: G5kConstants.java,v 1.8 2007/03/07 14:13:16 dloureir Exp $
...
public class G5kConstants {
    ...
    private static ArrayList<G5kSite> initSites(){
    	...
    	LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kConstants.class.getName(), "initSites", "Grid 5000 sites initialized");
    	return result;
    }
    ...
    private static ArrayList<G5kCluster> initClusters(){
    	...
    	LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kConstants.class.getName(), "initClusters", "Grid 5000 clusters initialized");
    	return result;
    }
