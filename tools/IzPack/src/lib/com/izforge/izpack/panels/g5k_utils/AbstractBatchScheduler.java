...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: AbstractBatchScheduler.java,v 1.2 2007/11/19 15:12:25 dloureir Exp $
...
public abstract class AbstractBatchScheduler implements BatchScheduler {
     ...
     */
    public abstract String[] delJob(Connection conn, String batch_host, String jobId, com.izforge.izpack.panels.g5k_utils.BatchSchedulerListener listener);
     ...
     */
    public abstract GridJob[] getJobs(Connection conn, com.izforge.izpack.panels.g5k_utils.BatchSchedulerListener listener);
