...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: G5kCluster.java,v 1.3 2007/10/30 10:25:22 dloureir Exp $
 * $Log: G5kCluster.java,v $
 * Revision 1.3  2007/10/30 10:25:22  dloureir
...
public class G5kCluster {
     ...
     */
    public final static int clusterRennesParamount       = 7;
    /**
     * Index of the gdx cluster of the Orsay's site
     */
    public final static int clusterOrsayGdx    	    = 8;
    /**
     * Index of the netgdx cluster of the Orsay's site
     */
    public final static int clusterOrsayNetgdx    	    = 9;
    /**
     * Index of the bordeplage cluster of the Bordeaux's site
     */
    public final static int clusterBordeauxBordeplage   = 10;
    /**
     * Index of the bordereau cluster of the Bordeaux's site
     */
    public final static int clusterBordeauxBordereau   = 11;
    /**
     * Index of the bordemer cluster of the Bordeaux's site
     */
    public final static int clusterBordeauxBordemer   = 12;
    /**
     * Index of the borderline cluster of the Bordeaux's site
     */
    public final static int clusterBordeauxBorderline   = 13;
    /**
     * Index of the violette cluster of the Toulouse's site
     */
    public final static int clusterToulouseViolette       = 14;
    /**
     * Index of the pastel cluster of the Toulouse's site
     */
    public final static int clusterToulousePastel       = 15;
    /**
     * Index of the chuque cluster of the Lille's site
     */
    public final static int clusterLilleChuque    	    = 16;
    /**
     * Index of the chti cluster of the Lille's site
     */
    public final static int clusterLilleChti    	    = 17;
    /**
     * Index of the chicon cluster of the Lille's site
     */
    public final static int clusterLilleChicon    	    = 18;
    /**
     * Index of the chinqchint cluster of the Lille's site
     */
    public final static int clusterLilleChinqchint    	    = 19;
    /**
     * Index of the grelon cluster of the Nancy's site
     */
    public final static int clusterNancyGrelon    	    = 20;
    /**
     * Index of the genepi cluster of the Grenoble's site
     */
    public final static int clusterGrenobleGenerpi 	    = 21;
    ...
    private final static String [] oarFrontals
        = {"frontend.lyon.grid5000.fr", "frontend.lyon.grid5000.fr",
           ...
           "frontend.rennes.grid5000.fr", "frontend.rennes.grid5000.fr", "frontend.rennes.grid5000.fr", 
           "frontend.orsay.grid5000.fr","fronted.orsay.grid5000.fr",
           "frontend.bordeaux.grid5000.fr","frontend.bordeaux.grid5000.fr","frontend.bordeaux.grid5000.fr", "frontend.bordeaux.grid5000.fr",
           "frontend.toulouse.grid5000.fr", "frontend.toulouse.grid5000.fr",
           "frontend.lille.grid5000.fr","frontend.lille.grid5000.fr","frontend.lille.grid5000.fr", "frontend.lille.grid5000.fr",
    ...
    private final static String[] clusterNames
        = {"Lyon--Capricorne", "Lyon--Sagittaire",
           ...
           "Rennes--Paraquad","Rennes--Paravent","Rennes--Paramount",
           "Orsay--Gdx","Orsay--Netgdx",
           "Bordeaux--Bordeplage","Bordeaux--Bordereau","Bordeaux--Bordemer","Bordeaux--Borderline",
           "Toulouse--Violette", "Toulouse--Pastel",
           "Lille--Chuque","Lille--Chti","Lille--Chicon","Lille--Chinqchint",
           "Nancy--Grelon",
           "Grenoble--Genepi"};
    ...
    = {"capricorne", "sagittaire",
        "azur", "helios","sol",
        "paraquad","paravent","paramount",
        "gdx","netgdx",
        "bordeplage","bordereau","bordemer","borderline",
        "violette","pastel",
        "chuque","chti","chicon","chinqchint",
        "grelon",
        "genepi"};
