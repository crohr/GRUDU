...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: BatchSchedulerMgr.java,v 1.2 2007/11/19 15:12:25 dloureir Exp $
...
public class BatchSchedulerMgr  {
    ...
    private void init() {
        ...
        try {
            ArrayList<Class> classes = PluginUtil.getClassesForPackage("com.izforge.izpack.panels.g5k_utils", BatchScheduler.class);
