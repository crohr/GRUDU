...
public class ShellScript
{
    ...
    /** internal SourceCode Management ( currently 'svn') ID :: 'SCM_ID = "$Id: ShellScript.java,v 1.1 2007/07/06 09:14:39 dloureir Exp $"' */
    private final static String SCM_ID = "$Id: ShellScript.java,v 1.1 2007/07/06 09:14:39 dloureir Exp $";

    /** internal Revision = "$Revision: 1.1 $" */
    private final static String Revision = "$Revision: 1.1 $";
