 ...
 *
 */
public class SwapHistoryChart extends JPanel implements ganglia.misc.Observer{
    ...
    private String titleOfTheGraph = "Swap usage";
     ...
     */
    public SwapHistoryChart(String hostName, double range) {
    	this.name = hostName+"|swap";
    ...
    public void addOrUpdateData(String metric, long date, double value) {
    	if(metric.equalsIgnoreCase(MetricNames.SWAP_USED)) seriesUsed.addOrUpdate(new Millisecond(new Date(date)), value);
    	else{
