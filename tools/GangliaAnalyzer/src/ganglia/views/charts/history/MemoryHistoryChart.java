 ...
 *
 */
public class MemoryHistoryChart extends JPanel implements ganglia.misc.Observer{
    ...
    private String titleOfTheGraph = "Memory usage";
    ...
    private String axisYName = "Memory used in KB";
     ...
     */
    public MemoryHistoryChart(String hostName, double range) {
    	this.name = hostName+"|mem";
    ...
    public void addOrUpdateData(String metric, long date, double value) {
    	if(metric.equalsIgnoreCase(MetricNames.MEM_USED)) seriesUsed.addOrUpdate(new Millisecond(new Date(date)), value);
    	else{
