 ...
 *
 */
public class PktsHistoryChart extends JPanel implements ganglia.misc.Observer{
    ...
    private String titleOfTheGraph = "History of the in/out Packets";
    private String nameOfTheDataToPlotIn = "Packets in";
    private String nameOfTheDataToPlotOut = "Packets out";
    private String axisXName = "Time";
    private String axisYName = "Packets/sec";
     ...
     */
    public PktsHistoryChart(String hostName,double range) {
    	name = hostName+"|" + "pkts";
    ...
    public void addOrUpdateData(String metric, long date, double value) {
    	if(metric.equalsIgnoreCase(MetricNames.PKTS_IN)) seriesIn.addOrUpdate(new Millisecond(new Date(date)), value);
