...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: GridJob.java,v 1.11 2007/11/06 11:20:40 aamar Exp $
 * $Log: GridJob.java,v $
 * Revision 1.11  2007/11/06 11:20:40  aamar
 * Adding for oarstat operation in OAR2 to choose between XML or classic output (via .diet/oar2.properties)
 *
 * Revision 1.10  2007/11/05 13:58:40  dloureir
...
//        result += this.myParams[GridJob.GJOB_SCHEDTIME];
    ...
    public abstract String getJobRSHConnectionCommand();
    
    public abstract String getJobRCPCommand();
}
