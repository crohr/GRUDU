...
/* $LICENSE$                                                                */
/****************************************************************************/
/* $Id: G5kCfg.java,v 1.21 2007/11/08 09:55:16 dloureir Exp $
 * $Log: G5kCfg.java,v $
 * Revision 1.21  2007/11/08 09:55:16  dloureir
 * Removing an unused property (it has been moved to the ApplicationConfiguration)
 *
...
//    public static final int SHOWTOTDONSTARTUP = 9;
     ...
     * 
     */
    public static final int JAVAHOME = 9;
    /**
     * Number of parameters
     */
    private static final int GLOBAL_PARAM_COUNT  = 10;
    ...
    public static void initCfg() {
        ...
        if (cfgDir.exists() && (!cfgDir.isDirectory())) {
            LoggingManager.log(Level.SEVERE, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "initCfg", "The " + homeDir + "/.diet exists and its not a directory!" );
            System.exit(1);
        }
        ...
        try {
            if (!cfgDir.exists()) {
                cfgDir.mkdir();
                LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "initCfg", "The " + homeDir + "/.diet has been created" );
            }
        }
        catch (SecurityException e) {
            LoggingManager.log(Level.SEVERE, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "initCfg", "Cannot create the .diet directory");
            System.exit(1);
        }

        readCfgFile();
        LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "initCfg", "Grid 5000 configuration initialized");
    } // end initCfg
    ...
    public static void readCfgFile() {
        ...
        if (!cfgFile.exists()) {
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL,G5kCfg.class.getName(),"readCfgFile","Config file not found!");
            generateNewConfigFile();
            return;
        }

        getProperties(cfgFile);
        LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "readCfgFile", "Grid 5000 config file read");
    }
...
//            set(G5kCfg.SHOWTOTDONSTARTUP,   showTipOfTheDayOnStartup);
            ...
            LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "getProperties","Properties retrieved from config file");
        }
        catch (javax.xml.xpath.XPathExpressionException e) {
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "getProperties", "XPath expression error");
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "getProperties",e);
        }
    }
    ...
    private static Document getDoc(File file) {
        try {
            ...
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc","Error while creating a new builder for config file : " + file.getAbsolutePath());
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc",e);
            return null;
        }
        catch (SAXException e) {
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc","Error while parsing the document for file : " + file.getAbsolutePath());
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc",e);
            return null;
        }
        catch (IOException e) {
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc","I/O Error for file : " + file.getAbsolutePath());
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"getDoc",e);
            return null;
        }
        // Unreachable
...
//        xml += newline + "<!-- G5K Sites -->" + newline;
    ...
    public static boolean save() {
        ...
        try {
            ...
            writer.write(toXML());
            writer.close();
            LoggingManager.log(Level.CONFIG, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "save", "Grid 5000 Configuration written to XML file : "+ cfgFile.getAbsolutePath());;
        }
        catch (IOException e) {
            LoggingManager.log(Level.WARNING,LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(),"save","Error while writing the XML file for file : " + cfgFile.getAbsolutePath());
            LoggingManager.log(Level.WARNING, LoggingManager.RESOURCESTOOL, G5kCfg.class.getName(), "save", e);
            return false;
        }
        return true;
    }
